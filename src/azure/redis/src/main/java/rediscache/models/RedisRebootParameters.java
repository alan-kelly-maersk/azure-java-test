...
public final class RedisRebootParameters implements JsonSerializable<RedisRebootParameters> {
     ...
     */
    public RedisRebootParameters setRebootType(RebootType rebootType) {
     ...
     * @return the RedisRebootParameters object itself.
     */
    public RedisRebootParameters setShardId(Integer shardId) {
     ...
     * @return the RedisRebootParameters object itself.
     */
    public RedisRebootParameters setPorts(List<Integer> ports) {
        this.ports = ports;
        return this;
    }
